...
//            fpsText = game.add.text(16, 50, 'fps: 0', { fontSize: '32px', fill: '#FFF' });
            ...
            contactMaterial.restitution = 5.0;  // Restitution (i.e. how bouncy it is!) to use in the contact of these two materials.
            ...
            for (var i = 0; i < 15; i++)
            {
                var circle = circles.create(radius + (i * radius * 1.5), radius + (i * radius * 1.5), 'agent');
